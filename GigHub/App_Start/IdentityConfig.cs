...
namespace GigHub
{
    ...
    public class CustomUserManager : UserManager<User>
    {
        ...
        {
            var manager = new CustomUserManager(new UserStore<User>(context.Get<CustomIdentityDbContext>()));
    ...
    public class CustomSignInManager : SignInManager<User, string>
    {
        ...
        {
            return user.GenerateUserIdentityAsync(UserManager as CustomUserManager);
        }
